...
<!-- Typing SVG -->
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Hey+there!+I'm+Mohamed+Gasser+%F0%9F%91%8B;Computer+%26+Communication+Engineer;Software+Developer+%7C+Systems+Builder;Always+learning%2C+always+building+%F0%9F%9A%80)](https://git.io/typing-svg)

<img src="https://capsule-render.vercel.app/api?type=waving&amp;color=gradient&amp;customColorList=6,11,20&amp;height=180&amp;section=header&amp;text=Mohamed+Gasser&amp;fontSize=60&amp;fontColor=fff&amp;animation=twinkling&amp;fontAlignY=35&amp;desc=Computer%20%2526%20Communication%20Engineering%20Student&amp;descAlignY=60&amp;descSize=18" width="100%"/>
...
class Mohamed:
    ...
    focus      = ["Software Development", "Systems Programming", "Networks"]
    languages  = ["C", "C++", "Java", "Python"]
    interests  = ["Scalable Systems", "Deep Learning", "Low-level Programming"]
    currently  = "Building cool stuff and pushing commits 🔨"
```
